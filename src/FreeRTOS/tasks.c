...
PRIVILEGED_DATA static portTickType xNextTaskUnblockTime            = ( portTickType ) portMAX_DELAY;
  ...
  static void prvGenerateRunTimeStatsForTasksInList( unsigned char *pcWriteBuffer, xList *pxList, unsigned long ulTotalRunTime ) PRIVILEGED_FUNCTION;
...
/*-----------------------------------------------------------*/
  ...
  static void prvGenerateRunTimeStatsForTasksInList( unsigned char *pcWriteBuffer, xList *pxList, unsigned long ulTotalRunTime )
  {
  volatile tskTCB *pxNextTCB, *pxFirstTCB;
    ...
    do
    {
      ...
      if( ulTotalRunTime > 0UL )
      {
        ...
        else
        {
          ...
          ulStatsAsPercentage = (uint8_t) (ulRunTimeCounter / ulTotalRunTime);
