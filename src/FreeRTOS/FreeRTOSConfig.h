 ...
 *
 * On defini ici la fonction qui sera appelée à chaque fois que l'interruption du tick système à lieu.
 * On l'utilise comme reset du wdt.
 * Comme cette fonction ne fait qu'une ligne, pour économiser un appel de fonction, on en fait une macro.
 * Si on désire en refaire une fonction, il faut penser à décommenter la ligne 337 de tasks.c (prototype de la fonction)
 * --------------------------------------------------------------------------
 */
#include <wdt.h>
